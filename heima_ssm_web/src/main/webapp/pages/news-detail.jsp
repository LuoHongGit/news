...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				新闻管理 <small>新闻表单</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/product/findAll.do">新闻管理</a></li>
				<li class="active">新闻表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/news/save.do"
				method="post">
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">关键字</div>
						<div class="col-md-4 data">
						...
						<div class="col-md-2 title">上次提交时间</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="submitDateStr"
								   value="${news.submitDateStr}">
						</div>
						<div class="col-md-2 title">状态</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="statusStr"
								   value="${news.statusStr}">
						</div>

						<div class="col-md-2 title">修改意见</div>
						<div class="col-md-4 data">
